...
description: "Pencil 原型绘制、自校验与截图验证。USE WHEN: 画原型、Pencil、batch_design、snapshot_layout、自校验、布局修复、导出截图、原型验证、页面绘制、设计校验"
---
...
2. **设计质量审查**：每完成一个页面，调用 `ui-ux-pro-max` skill 检查对比度、间距、触控目标等。本 skill 管"画对"，ui-ux-pro-max 管"画好"
